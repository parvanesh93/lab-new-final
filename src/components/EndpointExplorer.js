    ...
    return <div className="so-back">
      <div className="so-chunk">
        <div className="pageIntro">
          <p>
            This tool can be used to run queries against the REST API endpoints on the
            Horizon server. Horizon is the client facing library for the Kuknos ecosystem.</p>
        </div>
